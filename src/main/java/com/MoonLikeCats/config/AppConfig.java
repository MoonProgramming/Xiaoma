package com.MoonLikeCats.config;
...
@ComponentScans(value = { 
	      @ComponentScan("com.MoonLikeCats.dao"),
	      @ComponentScan("com.MoonLikeCats.service") 
	    })
public class AppConfig {
	...
	@Bean
	   public LocalSessionFactoryBean getSessionFactory() {
	      ...
	      factoryBean.setAnnotatedClasses(User.class, Client.class, ServiceProvider.class, SP_PublicInfo.class, SP_Language.class, SP_Gallery.class);
	      return factoryBean;
	   }
